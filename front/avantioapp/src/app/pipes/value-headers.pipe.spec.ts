...
describe('ValueHeadersPipe', () => {
  ...
  it('create an instance',
    inject(
      [ Restangular , HttpTestingController, ApiServeService ],
      (_RestangularHttp: Restangular , _HttpTestingController: HttpTestingController, _ApiServeService: ApiServeService) => {
